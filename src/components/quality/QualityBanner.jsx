...
const QualityBanner = () => {
    return (
        <div>
            <Image height={2000} width={2000} src={'/image/qualityBanner.webp'} className='w-full' alt='Quality banner' />
            <Image height={2000} width={2000} src={'/image/assurance.webp'} className='w-full px-44 py-20' alt='Assurance banner' />
