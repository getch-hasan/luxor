...
const QualityBanner = () => {
    return (
        <div>
            <img height={2000} width={2000} src={'/image/qualityBanner.webp'} className='w-full' alt='Quality banner' />
            <img height={2000} width={2000} src={'/image/assurance.webp'} className='w-full px-44 py-20' alt='Assurance banner' />
            <div className='py-10 px-20 md:px-64'>
                <p className='text-start text-xl'>Zan is a global leader and trendsetter in the writing and coloring instrument space. An obsessive focus on quality, design and suitability ensures that every consumer has maximum writing comfort. Our wide range of products caters to a variety of needs from students to working executives to artists. In the last fifty-four years, this owner-managed-family-run business has grown manifold, responsibility and the resultant experience and expertise has made us more aware towards our share of the, for our customers and partners.</p>
