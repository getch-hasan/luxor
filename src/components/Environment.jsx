        ...
        <div>
            ...
            <div className='' >
                <div className='grid grid-cols-3 sm:gap-5 md:gap-10 justify-between'>
                    <div className='grid justify-center'>
                        <Image className='max-w-[250px]' width={500} height={500} src={"/image/Quality.webp"} alt='Quality stationeries' />
                    </div>
                    <div className='grid justify-center'>
                        <Image className='max-w-[250px]' width={500} height={500} src={"/image/cicle.gif"} alt='Recycling cycle' />
                    </div>
                    <div className='grid justify-center'>
                        <Image className='max-w-[250px]' width={500} height={500} src={"/image/3r.webp"} alt='Reduce, Reuse, Recycle' />
                    </div>
                </div>
                <div className='grid grid-cols-2 sm:3 md:gap-10 justify-around'>
                    <div className='grid justify-center'>
                        <Image className='max-w-[250px]' width={500} height={500} src={"/image/Eco.webp"} alt='Eco-friendly products' />
                    </div>
                    <div className='grid justify-center'>
                        <Image className='max-w-[250px]' width={500} height={500} src={"/image/100Quality.webp"} alt='100% Quality' />
                    </div>
                </div>
                <div className='grid grid-cols-2 sm:gap-1 md:gap-3 lg:gap-5 lg:px-56 sm:px-16 justify-center'>
                    <div className='grid justify-center'>
                        <Image className='max-w-[250px]' width={500} height={500} src={"/image/Smooth.webp"} alt='Smooth writing experience' />
                    </div>
                    <div className='grid justify-center'>
                        <Image className='max-w-[250px]' width={500} height={500} src={"/image/100Quality.webp"} alt='High-quality stationeries' />
                    </div>
                </div>
            </div>
        </div>
